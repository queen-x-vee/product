...
const Header = () => {
  return (
    <header className="lg:pt-12 pt-6 text-white">
      <h4 className="text-section font-medium">Our Services</h4>
      <h1 className="pt-1 font-medium lg:text-5xl text-3xl max-w-lg lg:max-w-3xl">
      ...
      <div className="pt-5 space-y-5 md:space-y-0 md:space-x-10 flex flex-col md:flex-row">
        <Link href="/business" legacyBehavior>
          <a target="_blank">
            <Button className="bg-white text-black">Hire Tech Talents</Button>
          </a>
        </Link>
        <Link href="/business" legacyBehavior>
          <a target="_blank">
            <Button className="text-white">Order Merchandise</Button>
          </a>
        </Link>
      </div>
